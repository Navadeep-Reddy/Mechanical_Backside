...
def index():
    ...
    # If it's a post request, we get the data from the route and render landing page if correct else render login again with message
    if request.method == "POST":
        ...
        # Storing the username in a global variable to be reused outside this function
        about_name = username
